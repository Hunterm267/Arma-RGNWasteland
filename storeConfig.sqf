...
[
	...
	["Mi-48 Kajman (Hex)", "O_Heli_Attack_02_F", 55000, "vehicle"], // Mi-28 with gunner
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 55000, "vehicle"] // Mi-28 with gunner (black camo)
];
